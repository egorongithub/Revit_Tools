...
namespace SminexBimTools.Settings
{
    ...
    public class PluginSettings
    {
        ...
        /// <summary>
        /// Порядок мест поиска для правил с источником «Авто»:
        /// экземпляр / тип / системные. Поиск построчный: каждая строка
        /// правил проверяет места в этом порядке, прежде чем перейти
        /// к следующей строке. Шаг «Системные» находит встроенные параметры
        /// Revit по имени строки (включая недоступные обычному поиску).
        /// По умолчанию: экземпляр → тип → системные.
